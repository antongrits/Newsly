...
class AllArticlesAdapter(
    ...
    private val fragment: AllArticlesFragment
) : RecyclerView.Adapter<AllArticlesAdapter.Holder>() {
    ...
    override fun onBindViewHolder(h: Holder, pos: Int) {
        ...
        if (a.urlToImage.isNullOrEmpty()) {
            h.ivImage.setImageResource(R.drawable.newspaper)
            show()
        } else {
            Picasso.get()
                .load(a.urlToImage)
        ...
        h.ivHeart.setOnClickListener { fragment.updateArticle(a) }
    ...
    fun updateArticles(new: List<Article>) {
        articles = new
